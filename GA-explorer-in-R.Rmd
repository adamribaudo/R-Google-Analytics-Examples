...
ga_channels %>% 
  ...
  tab_style(
    style = list(cell_fill(color = "#F8F8F8"),
                 cell_borders(sides = "all", color = "#FFFFFF", style = "solid", weight = px(0)),
              cell_text(font = "Roboto", v_align="top",size=px(1),align="right")),
